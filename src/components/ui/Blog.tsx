  ...
  return (
    <div className="flex flex-col w-[416px] h-[699px] items-start gap-[35px]">
      ...
      <div className="flex flex-col gap-[35px] items-start">
        <ClientOnly>
          <button className="w-[196px] h-[54px] rounded-3xl flex items-center justify-center px-[32px] py-[15px] bg-[#FD853A] text-white text-[20px] hover:bg-[#e46e24] transition-colors">
            {button}
          </button>
        </ClientOnly>
